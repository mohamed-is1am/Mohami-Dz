                        ...
                        {profileInformation.map(({Name, age, wilaya, commune, Languers, spécialité}) => {
                            return(
                                ...
                                <div className="flex-wrap max-md:flex-col max-md:!gap-[20px] max-md:!items-start">
                                    <li><div><h3>Nom Complet</h3> <span>:</span></div> <span className="max-md:!pl-[20px]">BENALI AMINE</span></li>
                                    {/* <li><div><h3>Age </h3> <span>:</span></div> <span>AMI</span></li> */}
                                </div>
                                    <li><div><h3>Adresse cabinet avocats</h3> <span>:</span></div> <span className="max-md:!pl-[20px]">amizour/bejaia</span></li>
     
                                    <li><div><h3>Experiences:</h3> <span>:</span></div> <span className="max-md:!pl-[20px]">rien</span></li>
                                    <li><div><h3>Spécialité</h3> <span>:</span></div> <span className="max-md:!pl-[20px]">first: "Divorce",       second: "Droit Civil",       third: "Droit de la Famille",       fourth: "Droit Commercial - Concurrence",       fifth: "Droit de la Fonction Publique",       sixth: "Droit de l'Urbanisme",</span></li>
                                </>
                            )
                        })}
                    </ul>
